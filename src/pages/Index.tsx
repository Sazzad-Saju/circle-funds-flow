...
import { AlertTriangle, TrendingUp, DollarSign, Calendar, Users, Target, User, LogOut, MessageCircle, Bell, Home, BarChart3, CreditCard, UsersIcon } from 'lucide-react';
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <SidebarInset className="flex-1">
          {/* Mobile Header */}
          <div className="flex items-center justify-between p-4 border-b bg-white/95 backdrop-blur-sm lg:hidden">
            <SidebarTrigger />
          ...
          {/* Desktop Header */}
          <div className="hidden lg:flex items-center justify-between p-6 border-b bg-white/95 backdrop-blur-sm">
